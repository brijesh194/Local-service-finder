...
<body>
  ...
  <main class="container">
    ...
    <section class="hero">
      <div class="hero-grid">
        <div>
          <h1>Plumbers & Services in <span id="cityLabel">Lucknow</span></h1>
          <p class="muted">Showing verified and top-rated plumbers near you. Use filters to narrow results.</p>
